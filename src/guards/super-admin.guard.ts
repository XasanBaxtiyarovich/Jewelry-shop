...
export class SuperAdminGuard implements CanActivate {
    ...
    async canActivate(context: ExecutionContext){
        ...
        try {
            const admin: Partial<Admin> = await this.jwtService.verify(token, {secret: process.env.ACCES_TOKEN_KEY_ADMIN || 'MyAccesVery' });
            ...
            if(!admin.is_super) throw new BadRequestException('Admin not super');
